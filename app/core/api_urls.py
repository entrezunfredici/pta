...
urlpatterns = [
    ...
    path(
        "odoo-profiles/<int:profile_id>/test/",
        api_views.odoo_profile_test,
        name="odoo_profile_test",
    ),
    path(
        "odoo-profiles/<int:profile_id>/projects/",
        api_views.odoo_profile_projects,
        name="odoo_profile_projects",
    ),
    path(
    ...
    path(
        "git-profiles/<int:profile_id>/test/",
        api_views.git_profile_test,
        name="git_profile_test",
    ),
    path("automations/", api_views.automations, name="automations"),
    path(
        "automations/<int:automation_id>/run-task/",
